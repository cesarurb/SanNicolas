    ...
    children:[
      {
        ...
        children: [
          ...
          {
            name: 'gestionar-matricula',
            url: '/gestionMatricula',
            templateUrl: 'app/SGA/administrador/gestionMatriculas/gestorMatriculas.html',
            controller: 'gestorMatriculasCtrl as GMCtrl'
          }
        ]
      },
      {
