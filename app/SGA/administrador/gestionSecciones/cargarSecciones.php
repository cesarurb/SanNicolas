<?php
  ...
  $query = "select SECCION.id, seccion.idGrado, concat(GRADO.numeroGrado,'° ',GRADO.nivel) as grado, seccion.seccion, SECCION.turno from seccion inner join GRADO on GRADO.id = SECCION.idGrado where SECCION.anio='$anio' and SECCION.estado = 1";
  //
