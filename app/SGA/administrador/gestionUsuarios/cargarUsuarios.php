<?php
  ...
  $query = "select USUARIO.id, USUARIO.dni, USUARIO.NombreUsuario, ROL.rol, USUARIO.Nombres, USUARIO.Apellidos FROM USUARIO INNER JOIN ROL ON ROL.id = USUARIO.idRol WHERE estado = 1 and ROL.rol != 'ADMINISTRADOR'";
  //
