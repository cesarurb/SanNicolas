<?php
  ...
  //
  $query = "update alumno set nombres = upper('$nombres'), apellidos = upper('$apellidos'), correo = '$correo', telefono = '$telefono', direccion = upper('$direccion'), nacimiento = '$nacimiento', genero = '$genero', grupoSanguineo = '$grupoSanguineo' where id = '$id'";
